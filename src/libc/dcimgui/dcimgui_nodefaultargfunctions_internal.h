...
CIMGUI_API bool             ImGui_OpenPopupEx(ImGuiID id, ImGuiPopupFlags popup_flags /* = ImGuiPopupFlags_None */);
...
CIMGUI_API void                   ImGui_MultiSelectItemFooter(ImGuiID id, bool* p_selected, bool* p_pressed, ImGuiMultiSelectFlags extra_flags /* = 0 */);
...
CIMGUI_API void        ImGui_RenderNavCursor(ImRect bb, ImGuiID id, ImGuiNavRenderCursorFlags flags /* = ImGuiNavRenderCursorFlags_None */, float rounding /* = -1.0f */);  // Navigation highlight
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
