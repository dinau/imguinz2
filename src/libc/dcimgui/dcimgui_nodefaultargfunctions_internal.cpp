...
CIMGUI_API bool             cimgui::ImGui_OpenPopupEx(ImGuiID id, ImGuiPopupFlags popup_flags)
{
...
CIMGUI_API void                   cimgui::ImGui_MultiSelectItemFooter(ImGuiID id, bool* p_selected, bool* p_pressed, ImGuiMultiSelectFlags extra_flags)
{
...
CIMGUI_API void        cimgui::ImGui_RenderNavCursor(cimgui::ImRect bb, ImGuiID id, ImGuiNavRenderCursorFlags flags, float rounding)
{
